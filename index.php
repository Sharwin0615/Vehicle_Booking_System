...
<!--End Navigation-->
  ...
  <header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url('vendor/img/vbs.jpg')">
        </div>
        <!-- Slide Two - Set the background image for this slide in the line below -->
        <div class="carousel-item" style="background-image: url('vendor/img/vbs2.jpg')">
        </div>
        <!-- Slide Three - Set the background image for this slide in the line below -->
        <div class="carousel-item" style="background-image: url('vendor/img/vbs3.jpg')">
        </div>
  ...
  <div class="container">
    ...
    <h1 class="my-4" style="text-align: center;">Welcome to Vehicle Booking System</h1>
    ...
    <hr>
    <h1 class="my-4" style="text-align:center">Client Testimonials</h1>
